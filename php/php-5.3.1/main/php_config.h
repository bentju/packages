...
/*   */
#define PHP_SAFE_MODE_EXEC_DIR "/etc/appweb/exec"
...
/* PHP build date */
#define PHP_BUILD_DATE "2010-04-10"

/* hardcode for each of the cross compiler host */
#define PHP_OS "Darwin"

/* hardcode for each of the cross compiler host */
#define PHP_UNAME "Darwin saturn.local 10.2.0 Darwin Kernel Version 10.2.0: Tue Nov 3 10:37:10 PST 2009; root:xnu-1486.2.11~1/RELEASE_I386 i386"
